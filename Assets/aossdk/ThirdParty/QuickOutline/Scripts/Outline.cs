...
namespace AosSdk.ThirdParty.QuickOutline.Scripts
{
    ...
    public class Outline : MonoBehaviour
    {
        ...
        public OutlineMode OutlineOutlineMode
        {
            get => outlineOutlineMode;
            set
            {
                outlineOutlineMode = value;
                needsUpdate = true;
            }
        }
        ...
        [SerializeField] private OutlineMode outlineOutlineMode;
